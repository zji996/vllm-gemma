...
_WARN_ON_POTENTIAL_FORMAT_MISMATCH = (
    os.getenv("VLLM_FLA_WARN_ON_POTENTIAL_FORMAT_MISMATCH", "0") == "1"
)
...
def chunk_local_cumsum(
    ...
    **kwargs,
    ...
    if _WARN_ON_POTENTIAL_FORMAT_MISMATCH and not head_first and g.shape[1] < g.shape[2]:
        warnings.warn(
